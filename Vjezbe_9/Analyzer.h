...
// Wed Jan  19 18:26:31 2022 by ROOT version 6.24/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //my_meth
   virtual void     Fill(TH1F* h1, TH1F* h2, double S_t);
   std::tuple <double, double, double, double> Calc(double S_t);
   virtual void Plot(TH1F* h1, TH1F* h2, double S_t, std::tuple<double, double, double, double> tpl);
};
